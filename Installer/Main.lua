...
local repositoryURL = "https://raw.githubusercontent.com/TheHainDit/Hexagon-OS/master/"
local installerURL = "Installer/"
local EFIURL = "EFI/Minified.lua"

local installerPath = "/Hexagon-OS installer/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "Hexagon OS")
	return y + 2
end
...
local installerMenu = menu:addContextMenuItem("Hexagon OS", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("Hexagon-OS HDD")
	end
	...
	EEPROMProxy.setLabel("Hexagon-OS EFI")
