...
local host = "http://Hexagon-OS.modder.pw/Hexagon-OSAPI/2.04/"
...
editPublication = function(initialPublication, initialCategoryID)
	...
	dependenciesLayout.addButton.onTouch = function()
		...
		local publicationNameInput = container.layout:addChild(GUI.input(1, 1, 36, 3, 0xFFFFFF, 0x696969, 0xB4B4B4, 0xFFFFFF, 0x2D2D2D, "", "Hexagon OS"))
